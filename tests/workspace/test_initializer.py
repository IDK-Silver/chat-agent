...
class TestWorkspaceInitializer:
    def test_create_structure(self, tmp_path: Path):
        ...
        assert (working_dir / "kernel" / "agents" / "pre_reviewer" / "prompts" / "parse-retry.md").exists()
        ...
        assert (working_dir / "kernel" / "agents" / "memory_writer" / "prompts" / "system.md").exists()
        assert (working_dir / "kernel" / "agents" / "memory_writer" / "prompts" / "parse-retry.md").exists()
