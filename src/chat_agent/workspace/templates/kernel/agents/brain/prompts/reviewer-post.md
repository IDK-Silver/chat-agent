...
|-----------------|--------------------------|
| User shared new fact (health, diet, schedule, preference) | AI used `write_file` to save to `memory/agent/knowledge/` |
...
| Topic shifted | AI updated `memory/short-term.md` |
